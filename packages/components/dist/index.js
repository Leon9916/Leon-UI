import { h, nextTick, createVNode, defineComponent, openBlock, createBlock, unref, withCtx, renderSlot } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Button), { danger: "" }, {
        icon: withCtx(() => [
...
const index = {
  install(app) {
    app.component("UiButton", _sfc_main);
  }
};
export {
  _sfc_main as UiButton,
  index as default
};
