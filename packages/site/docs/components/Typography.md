...
## 代码演示
<demo src="../demo/typography/demo.vue"></demo>
...
| tooltip | 是否展示提示文本 | boolean | true |  |
| triggerType | Edit mode trigger - icon, text or both (not specifying icon as trigger hides it) | Array |  |
...
继承于[Antd-vue Typography 排版 API](https://www.antdv.com/components/typography-cn)